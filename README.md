...
- **Album filters** — the overview can be narrowed to albums containing suspect tracks (checkbox), albums with at least N suspects, or albums with verified tracks.
